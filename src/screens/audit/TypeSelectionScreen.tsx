...
const TypeSelectionScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070A0F] font-base px-6 pt-16 pb-32">
      <div className="w-full max-w-lg mx-auto">
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Farm Audit Card */}
          <div className="bg-[#121623] border border-white/5 rounded-[32px] p-7 shadow-xl">
            {/* Top Row: Icon & Badge */}
            <div className="flex justify-between items-start mb-6">
              <div className="w-[64px] h-[64px] rounded-[22px] border border-white/[0.08] flex items-center justify-center shrink-0">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="flex -space-x-2 shrink-0">
                ...
                <div className="w-8 h-8 rounded-full border-2 border-[#121623] bg-[#4DD0E1] flex items-center justify-center z-0">
          ...
          <div className="bg-[#121623] border border-white/5 rounded-[32px] p-7 shadow-xl">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="w-[64px] h-[64px] rounded-[22px] border border-white/[0.08] flex items-center justify-center shrink-0">
                <Store className="text-[#4DD0E1]" size={32} strokeWidth={1.5} />
              </div>
              <div className="px-3.5 py-1.5 rounded-full border border-white/10 mt-1">
                <span className="text-[#4DD0E1] text-[10px] uppercase font-bold tracking-[0.1em]">
                  RETAIL
                </span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="flex -space-x-2 shrink-0">
                ...
                <div className="w-8 h-8 rounded-full border-2 border-[#121623] bg-[#22353E] flex items-center justify-center z-10">
                  <span className="text-[#4DD0E1] text-[10px] font-bold">AJ</span>
                </div>
              </div>
              <span className="text-[#4A5570] text-[13px] font-semibold">
            ...
            <button 
              ...
              className="w-full bg-[#4DD0E1] hover:bg-[#5ce5f6] text-[#080B10] font-bold text-[16px] py-[18px] rounded-full shadow-[0_4px_25px_rgba(77,208,225,0.15)] transition-all active:scale-[0.98] cursor-pointer"
            >
